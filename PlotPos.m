...
zImage = [2 2; 1 1];   %# The z data for the image corners
surf(xImage,yImage,zImage,...    %# Plot the surface
     'CData',img,...
     'FaceColor','texturemap');
 
    img = imread('4.jpg');     %# Load a sample image
xImage = [1 2; 1 2];   %# The x data for the image corners
yImage = [0 0; 0 0];             %# The y data for the image corners
zImage = [2 2; 1 1];   %# The z data for the image corners
surf(xImage,yImage,zImage,...    %# Plot the surface
     'CData',img,...
  ...
  img = imread('2.jpg');     %# Load a sample image
xImage = [0 1; 0 1];   %# The x data for the image corners
yImage = [0 0; 0 0];             %# The y data for the image corners
...
surf(xImage,yImage,zImage,...    %# Plot the surface
   ...
   img = imread('3.jpg');     %# Load a sample image
xImage = [1 2; 1 2];   %# The x data for the image corners
yImage = [0 0; 0 0];             %# The y data for the image corners
zImage = [1 1; 0 0];   %# The z data for the image corners
surf(xImage,yImage,zImage,...    %# Plot the surface
